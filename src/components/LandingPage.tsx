...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white relative">
            {/* Logo */}
            <div className="w-20 md:w-24 mx-auto pt-6 md:pt-8">
            ...
            <div className="relative min-h-[calc(100vh-200px)] flex items-center justify-center px-4 md:px-0">
                {/* Left Image - Hidden on mobile, shown on medium screens and up */}
                <div className="hidden md:block absolute -left-20 top-1/2 -translate-y-1/2 w-80 h-96 overflow-hidden">
                    <Image
                ...
                {/* Right Image - Hidden on mobile, shown on medium screens and up */}
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 mb-8 md:mb-12 px-4 md:px-0">
                    ...
                    {/* Email Input */}
                    <div className="flex flex-col md:flex-row max-w-lg mx-auto px-4 md:px-0">
                        <input
                            type="email"
                            value={email}
                            onChange={(e) => setEmail(e.target.value)}
                            placeholder="name@email.com"
                            className="w-full md:flex-1 p-3 rounded-full md:rounded-l-full md:rounded-r-none border focus:outline-none focus:border-black mb-3 md:mb-0"
                        ...
                        <button
                            type="submit"
                            disabled={state === 'loading'}
                            className="w-full md:w-auto bg-black text-white px-6 py-3 rounded-full md:rounded-l-none md:rounded-r-full hover:bg-gray-800 disabled:opacity-50"
            ...
            <footer className="absolute bottom-0 w-full border-t border-gray-200">
                <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-12">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:gap-8">
                            <a href="#" className="text-xs md:text-sm text-gray-600 hover:text-black">INSTAGRAM</a>
                            <a href="#" className="text-xs md:text-sm text-gray-600 hover:text-black">TWITTER</a>
                            <a href="#" className="text-xs md:text-sm text-gray-600 hover:text-black">FILMMAKER? PARTNER
                                WITH US</a>
                        </div>
                    </div>
                </div>
